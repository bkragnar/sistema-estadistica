...
//$para = $usuario_correo;
$para="oscar.santander.inf@gmail.com";

$mensaje = "<h3>Restablecer Clave</h3>";
$mensaje .= "Hola $usuario_nombre !, se a procesado tu solicitud de recuperación de clave <a href='localhost/ssc/local/reset-pass/?w=$usuario_id&v=$key_random'><b>Restablecer Clave</b></a>";
